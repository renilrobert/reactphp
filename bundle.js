...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = {
		...
		fetchDetail: function fetchDetail(username) {
			...
			$.getJSON('/reactphp/api/users/' + username).then(function (res) {				
	...
	var UserCell = React.createClass({
		...
		navigateToUsername: function navigateToUsername(e) {
			...
			window.history.pushState(null, '', '/reactphp/users/' + this.props.username);
		},
		render: function render() {			
			return React.createElement(
				'div',
				...
				React.createElement(
					...
					React.createElement(
						'a',
						{ className: 'btn btn-default', href: '/reactphp/users/' + this.props.username, onClick: this.navigateToUsername },
						'View details'
					)
				)
			);
